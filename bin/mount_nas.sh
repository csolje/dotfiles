...
sudo mount -t cifs //10.0.0.4/Movies /home/chrs/nas/Movies -o username=cso,password='user password',workgroup=workgroup,uid=chrs,gid=chrs
sudo mount -t cifs //10.0.0.4/Music /home/chrs/nas/Music -o username=cso,password='user password',workgroup=workgroup,uid=chrs,gid=chrs
...
#sudo mount -t smb3 //10.0.0.4/Music /home/chrs/nas/Music -o username=cso,password='user password',workgroup=workgroup,uid=chrs,gid=chrs
#sudo mount -t smb3 //10.0.0.4/Pictures /home/chrs/nas/Pictures -o username=cso,password='user password',workgroup=workgroup,uid=chrs,gid=chrs
